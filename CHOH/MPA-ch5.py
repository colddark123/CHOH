...
all_inputs = np.float32(np.load("data/ch5_x.npy"))
all_targets = np.load("data/ch5_y.npy")
all_targets = all_targets[:,0:1]
all_targets = np.float32(all_targets)
...
from data.chData import MyGraphDataset
Dataset=MyGraphDataset(all_inputs,all_targets,device)

#split 50432 6304 6305
